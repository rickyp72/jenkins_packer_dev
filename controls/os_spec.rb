...
control 'os-05' do
  ...
  describe login_defs do
    # its('ENV_SUPATH') { should include('/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin') } RP
    # its('ENV_PATH') { should include('/usr/local/bin:/usr/bin:/bin') } RP
